...
cd oifs-43r3
export OIFS_TOPLEVEL_DIR=/p/scratch/chhb19/mandresm/testing/comp/awicm3/awicm3-v3.0/oifs-43r3; cd make; ../fcm/bin/fcm make -v -j8 -f oifs.cfg ; mv esm/oifs/bin/master.exe esm/oifs/bin/oifs
cd ..
