...
export GRIB_SAMPLES_PATH=<TEST_DIR>/comp/awiesm3/awiesm3-develop/oifs-48r1/build/share/eccodes/ifs_samples/grib1_mlgrib2
export OIFS_LOGFILE=<TEST_DIR>/comp/awiesm3/awiesm3-develop/oifs-48r1/build/oifs_test_log.txt
...
pushd oifs-48r1
./openifs-bundle create; ./openifs-bundle build --threads=32 --openifs-only --without-single-precision --with-cplng2 --with-oifs-xios --install; chmod -R 700 .; git config core.fileMode false; mv install/bin/ifsMASTER.DP install/bin/OpenIFS
popd
