...
pushd xios
export XIOS_TOPLEVEL=<TEST_DIR>comp/awiesm3/awiesm3-develop/xios; ./make_xios --arch ESMTOOLS_generic_oasis_gcc --netcdf_lib netcdf4_par --use_oasis oasis3_mct --job 24 --prod; cp bin/xios_server.exe bin/xios.x
popd
