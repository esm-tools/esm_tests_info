...
export GRIB_SAMPLES_PATH=<TEST_DIR>comp/awicm3/awicm3-v3.4/oifs-48r1/build/share/eccodes/ifs_samples/grib1_mlgrib2
export OIFS_LOGFILE=<TEST_DIR>comp/awicm3/awicm3-v3.4/oifs-48r1/build/oifs_test_log.txt
...
pushd xios
export XIOS_TOPLEVEL=<TEST_DIR>comp/awicm3/awicm3-v3.4/xios; ./make_xios --arch ESMTOOLS_generic_oasis_gcc --netcdf_lib netcdf4_par --use_oasis oasis3_mct --job 24 --prod; cp bin/xios_server.exe bin/xios.x
popd
