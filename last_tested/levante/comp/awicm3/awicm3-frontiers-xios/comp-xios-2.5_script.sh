...
cd xios
export XIOS_TOPLEVEL=/work/<ACCOUNT>/a270152/testing/comp/awicm3/awicm3-frontiers-xios/xios; ./make_xios --arch ESMTOOLS_levante_oasis_intel --netcdf_lib netcdf4_par --use_oasis oasis3_mct --job 24 --prod; cp bin/xios_server.exe bin/xios.x
cd ..
