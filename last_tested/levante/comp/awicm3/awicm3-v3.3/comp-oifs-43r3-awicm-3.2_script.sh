...
pushd oifs-43r3
export OIFS_TOPLEVEL_DIR=<TEST_DIR>comp/awicm3/awicm3-v3.3/oifs-43r3; export OIFS_XIOS=enable ; export OIFS_XIOS_DIR=<TEST_DIR>comp/awicm3/awicm3-v3.3/oifs-43r3/../xios ; export OIFS_XIOS_INCLUDE=-I/<TEST_DIR>comp/awicm3/awicm3-v3.3/oifs-43r3/../xios/inc/; cd make; ../fcm/bin/fcm make -v -j8 -f oifs.fcm ; chmod -R 700 .; git config core.fileMode false; mv esm/oifs/bin/master.exe esm/oifs/bin/oifs
popd
